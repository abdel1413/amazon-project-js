...
const renderOrderSummary = () => {
  ...
  cart.forEach((cartItem) => {
    ...
    //if the cart id and deliverOption id match,
    // then we found the correct item to deliver
    let delivery;
  ...
  document.querySelectorAll(".js-delivery-option").forEach((element) => {
    element.addEventListener("click", () => {
      ...
      console.log("prodId cart pro id", productId);
      console.log("deliId opti id", deliveryOptionId);
